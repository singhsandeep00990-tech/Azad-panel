...
class DashboardPage extends StatelessWidget {
  ...
  Future<void> setMotor(
    ...
    try {
      ...
      debugPrint('Motor update error: $e');
    }
  }
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          final motors = Map<String, dynamic>.from(
            (data['motors'] as Map?) ?? {},
          );
          ...
          return ListView(
            ...
            children: [
              MotorCard(
                title: 'MOTOR 1',
                isOn: motors['motor1'] == true,
                onChanged: (value) {
                  setMotor('motor1', value);
                },
              ),
              const SizedBox(height: 16),
              MotorCard(
                title: 'MOTOR 2',
                isOn: motors['motor2'] == true,
                onChanged: (value) {
                  setMotor('motor2', value);
                },
              ),
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  final faultKey = 'fault${index + 1}';
                  final currentKey = 'current${index + 1}';

                  final fault = faults[faultKey] == true;
                  final current = currents[currentKey];
