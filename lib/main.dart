...
Future<void> main() async {
  ...
  await Firebase.initializeApp(
    options: const FirebaseOptions(
      ...
      databaseURL: 'https://azad-panel-default-rtdb.firebaseio.com',
    ),
  );
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  final DatabaseReference deviceRef =
      FirebaseDatabase.instance.ref('panels/$deviceId');
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DatabaseEvent>(
        ...
        builder: (context, snapshot) {
          ...
          final bool motor = data['motor'] == true;
          final bool wifi = data['wifi'] == true;
          final bool main = data['main'] == true;

          final bool rPhase = data['rPhase'] == true;
          final bool yPhase = data['yPhase'] == true;
          final bool bPhase = data['bPhase'] == true;

          final bool overload = data['overload'] == true;
          final bool dryRun = data['dryRun'] == true;
          ...
          final double currentR =
              _toDouble(data['currentR']);

          final double currentY =
              _toDouble(data['currentY']);

          final double currentB =
              _toDouble(data['currentB']);

          final double currentTotal =
              _toDouble(data['currentTotal']);
          ...
          return ListView(
            ...
            children: [
              ...
              StatusCard(
                title: 'WIFI STATUS',
                value: wifi ? 'CONNECTED' : 'DISCONNECTED',
                active: wifi,
              ),
...
class TotalCurrentCard extends StatelessWidget {
  final double value;
